...
insert into params values("Show all transactions", "AcctList");
...
insert into params values("Daily average inflow", "AcctList");	
insert into params values("Daily average inflow", "Final Date");
insert into params values("Daily average inflow", "Number of Days");
